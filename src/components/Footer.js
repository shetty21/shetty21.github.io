    ...
    <div style={{
      ...
      <div style={{ minWidth: 160, marginBottom: "1.5rem" }}>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: "1.7" }}>
          ...
          <li><a href="#education" style={footerLinkStyle}>Education</a></li>
          <li><a href="#experience" style={footerLinkStyle}>Experience</a></li>
          <li><a href="#projects" style={footerLinkStyle}>Projects</a></li>
          <li><a href="#skills" style={footerLinkStyle}>Skills</a></li>
        </ul>
      </div>
      {/* Right Section */}
      <div style={{ minWidth: 160, marginBottom: "1.5rem" }}>
